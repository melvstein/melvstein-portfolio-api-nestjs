...
export type StorageHash =
  StorageHashBase<'01205d3b6a0bac90783d5f14163e395ff07d3572bcbe0232c6e3e1b51b7c0ec1'>;
        ...
        readonly entries: {
          readonly table: {
              ...
              uniques: readonly [
                {
                  ...
                  readonly name: 'auth_credentials_userId_key';
                },
              ];
              indexes: readonly [];
              foreignKeys: readonly [
                {
                  ...
                  readonly name: 'auth_credentials_userId_fkey';
                },
              ];
            };
            readonly auth_tokens: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'auth_tokens_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  ...
                  readonly name: 'auth_tokens_userId_fkey';
                },
              ];
            };
            readonly permissions: {
            ...
            readonly role_permissions: {
              ...
              indexes: readonly [
                {
                  readonly name: 'role_permissions_permissionId_idx';
              ...
              foreignKeys: readonly [
                {
                  ...
                  readonly name: 'role_permissions_permissionId_fkey';
                },
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                  ...
                  readonly name: 'role_permissions_roleId_fkey';
                },
              ];
            };
            readonly roles: {
            ...
            readonly user_profiles: {
              ...
              uniques: readonly [
                {
                  readonly columns: readonly ['userId'];
                  readonly name: 'user_profiles_userId_key';
                },
              ];
              indexes: readonly [];
              foreignKeys: readonly [
                {
                  ...
                  readonly name: 'user_profiles_userId_fkey';
                },
              ];
            };
            readonly user_roles: {
              ...
              indexes: readonly [
                {
                  readonly name: 'user_roles_roleId_idx';
                  readonly columns: readonly ['roleId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  ...
                  readonly name: 'user_roles_roleId_fkey';
                },
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                  ...
                  readonly name: 'user_roles_userId_fkey';
                },
              ];
            };
            readonly users: {
